...
urlpatterns = [
    # GET
    path(
        "vehicle/<str:plate_number>/", views.FetchOneVehicle.as_view(), name="vehicle"
    ),
    ...
    # update
    path("vehicle-update/", views.UpdateVehicle.as_view(), name="vehicle-update"),
    # DELETE
    path(
        "vehicle-delete/<str:pk>/", views.DeleteVehicle.as_view(), name="vehicle-delete"
    ),
    path(
        "resident-delete/<str:pk>/",
        views.DeleteResident.as_view(),
